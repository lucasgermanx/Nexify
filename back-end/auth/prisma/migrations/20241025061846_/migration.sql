...
-- AddForeignKey
ALTER TABLE `AccountActivationToken` ADD CONSTRAINT `AccountActivationToken_user_reference_fkey` FOREIGN KEY (`user_reference`) REFERENCES `Users`(`user_reference`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `RecoverTokens` ADD CONSTRAINT `RecoverTokens_user_reference_fkey` FOREIGN KEY (`user_reference`) REFERENCES `Users`(`user_reference`) ON DELETE CASCADE ON UPDATE CASCADE;
