export const NotFoundList = ({title}:{title:string}) => {
    return (
      <>
        <center className="mt-5" style={{ padding: '48px 24px' }}>
          <h1 style={{ fontSize: "45px", fontWeight: "600", color: "rgba(255, 255, 255, 0.4)", marginBottom: '16px' }}>
            Oops...
          </h1>
          <p style={{ color: "rgba(255, 255, 255, 0.6)", fontSize: '1rem', marginBottom: '24px' }}>{title}</p>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="60" height="60" fill="rgba(255, 255, 255, 0.2)">
            <title>robot-dead</title>
